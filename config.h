...
static const Key keys[] = {
	...
	#if TAB_PATCH
	{ Mod4Mask|ControlMask,           XK_b,          tabmode,                {-1} },
	#endif // TAB_PATCH
	#if FOCUSMASTER_PATCH
	{ Mod4Mask|ControlMask,           XK_space,      focusmaster,            {0} },
	...
	{ Mod4Mask,                       XK_s,          swapfocus,              {.i = -1 } },
	#endif // SWAPFOCUS_PATCH
	#if SWITCHCOL_PATCH
	{ Mod4Mask,                       XK_v,          switchcol,              {0} },
	#endif // SWITCHCOL_PATCH
	#if ROTATESTACK_PATCH
	{ Mod4Mask|Mod4Mask,              XK_j,          rotatestack,            {.i = +1 } },
	{ Mod4Mask|Mod4Mask,              XK_k,          rotatestack,            {.i = -1 } },
	#endif // ROTATESTACK_PATCH
	#if INPLACEROTATE_PATCH
	{ Mod4Mask|Mod4Mask,              XK_j,          inplacerotate,          {.i = +2 } }, // same as rotatestack
	{ Mod4Mask|Mod4Mask,              XK_k,          inplacerotate,          {.i = -2 } }, // same as reotatestack
	{ Mod4Mask|Mod4Mask|ShiftMask,    XK_j,          inplacerotate,          {.i = +1} },
	{ Mod4Mask|Mod4Mask|ShiftMask,    XK_k,          inplacerotate,          {.i = -1} },
...
static const Command commands[] = {
	...
	{ {Mod4Mask, ShiftMask,  0,         0},    {XK_w,      XK_h,     0,         0},            setlayout,       {.v = &layouts[0]} },
	{ {Mod4Mask, 0,          0,         0},    {XK_w,      XK_o,     0,         0},            setlayout,       {.v = &layouts[2]} },
	{ {Mod4Mask, ShiftMask,  0,         0},    {XK_w,      XK_o,     0,         0},            onlyclient,      {0} },
	{ {Mod4Mask, 0,          0,         0},    {XK_w,      XK_v,     0,         0},            setlayout,       {.v = &layouts[0]} },
	{ {Mod4Mask, 0,          0,         0},    {XK_w,      XK_less,  0,         0},            setmfact,        {.f = -0.05} },
	{ {Mod4Mask, ShiftMask,  0,         0},    {XK_w,      XK_less,  0,         0},            setmfact,        {.f = +0.05} },
	{ {Mod4Mask, ShiftMask,  0,         0},    {XK_w,      XK_0,     0,         0},            setmfact,        {.f = +1.50} },
